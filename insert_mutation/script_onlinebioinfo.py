...
lista_ori = leArquivoSequencia(sys.argv[1])
mut = leArquivoMutacoes(sys.argv[2])

lista_mut = lista_ori.copy()
fazSubstituicoes(lista_mut, mut)
fazDelecoes(lista_mut, mut)
fazInsercoes(lista_mut, mut)

seq_final = geraSequenciaFinal(lista_mut)

#imprimeComparativo(lista_ori, seq_final)
print(seq_final)